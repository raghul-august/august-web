export function getCountryInfoByCode(countryCode: string) {
...
export const countryCodes = [
  ...
  { name: "St. Kitts and Nevis", dial_code: "+1869", code: "KN", flag: "🇰🇳" },
  { name: "St. Lucia", dial_code: "+1758", code: "LC", flag: "🇱🇨" },
  { name: "St. Vincent and the Grenadines", dial_code: "+1784", code: "VC", flag: "🇻🇨" },
