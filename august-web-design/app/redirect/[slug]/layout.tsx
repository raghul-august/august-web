...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    switch (slug) {
      ...
      case 'app':
        return {
          ...
          description: 'Your personal AI health companion. Download the August app for personalized health support, lab report analysis, and wellness tracking.',
          image: 'https://augustbuckets.blob.core.windows.net/web-app-assets/join-august.png',
        };
      default:
        return {
  ...
  return {
    ...
    openGraph: {
      title: meta.title,
      description: meta.description,
      url: `https://www.meetaugust.ai/redirect/${slug}`,
      siteName: 'August AI',
      images: [
        {
          url: meta.image,
