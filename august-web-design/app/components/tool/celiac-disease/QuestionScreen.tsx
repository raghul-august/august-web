...
export default function QuestionScreen({
  ...
  return (
    <QuizQuestionScreen
      ...
      onBack={onBack}
      questionClassName="text-[1.2rem] font-medium leading-[1.4] text-[var(--text-primary)] tracking-[-0.01em] m-0 max-[480px]:!text-[1.1rem]"
