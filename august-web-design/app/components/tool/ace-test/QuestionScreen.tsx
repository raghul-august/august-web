...
interface QuestionScreenProps {
  question: AceQuestion;
  currentIndex: number;
  totalQuestions: number;
  selectedAnswer: 0 | 1 | null;
...
export default function QuestionScreen({
  ...
  return (
    <QuizQuestionScreen
      ...
      onBack={onBack}
      questionClassName="text-[1.15rem] font-medium leading-[1.5] text-[var(--text-primary)] tracking-[-0.01em] m-0 max-[480px]:!text-[1.05rem]"
      contentClassName="flex-1 flex flex-col justify-center p-[24px_24px_32px] max-w-[640px] mx-auto w-full"
      questionBlockClassName="mb-[28px]"
      optionsClassName="flex flex-col gap-[8px] mb-auto"
    >
      {ACE_OPTIONS.map((option, index) => {
